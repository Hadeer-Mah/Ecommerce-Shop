...
const Product = ({product}) => {
  ...
  return (
    <>
    <div>
      <div className='h-[300px] border border-[#e4e4e4] mb-4 relative overflow-hidden group transition'>
        ...
        <div className='absolute top-6 -right-11 group-hover:right-5 p-2 flex flex-col justify-center items-center gap-y-2
